...
namespace Nest.BaseCore.Payment.PaymentSDK.Wechat
{
    ...
    public class WxPayData
    {
        ...
        * @throws WxPayException
        */
        public SortedDictionary<string, object> FromXml(string xml, string key = WechatConfig.Key)
        {
        ...
        */
        public string MakeSign(string key = WechatConfig.Key)
        {
            //转url格式
            string str = ToUrl();
            //在string后加入API KEY
            str += "&key=" + key;
            //LogHelper.LogInfo("WxPayApi APP", "WX=" + str);
            //MD5加密
            var md5 = MD5.Create();
